...
// ─── RDS storage (us-east-1 on-demand prices) ─────────────────────────────────

export const RDS_GP2_STORAGE_PER_GB = 0.115;
...
// ─── EC2 fallback prices (us-east-1, Linux on-demand, per-hour) ──────────────
...
// ─── ElastiCache fallback prices (us-east-1, per-hour on-demand) ─────────────
