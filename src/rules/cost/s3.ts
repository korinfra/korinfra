...
export function checkS3003(r: Resource, _cfg: Cfg, ctx?: RuleContext): Recommendation | null {
  if (r.type !== 's3_bucket') return null;
...
export function checkS3004(r: Resource, _cfg: Cfg, ctx?: RuleContext): Recommendation | null {
  if (r.type !== 's3_bucket') return null;
